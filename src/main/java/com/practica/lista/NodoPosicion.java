...
/**
 * Nodo para la lista de coordenadas. En el guardamos cuántas personas  están en una coordenada  en un momento temporal.
 * También guardaremos la lista de personas que están en esa coordenada en un momento en concreto
 */
