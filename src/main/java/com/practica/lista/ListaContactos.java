...
public class ListaContactos {
	...
	/**
	 * Insertamos en la lista de nodos temporales, y a la vez inserto en la lista de nodos de coordenadas. En la lista
	 * de coordenadas metemos el documento de la persona que está en esa coordenada en un instante
	 */
	...
	private void insertarNodo (NodoTemporal aux, PosicionPersona p) {
	...
	/**
	 * Métodos para comprobar que insertamos de manera correcta en las listas de coordenadas, no tienen una utilidad en
	 * sí misma, más allá de comprobar que nuestra lista funciona de manera correcta.
	 */
